...
colourpickerClass.prototype = {
    ...
    getColourOnPositionOfScroll(el, ev) {
        if (el instanceof HTMLElement && ev instanceof MouseEvent) {
            ...
            var eventTopOnScrollbar = eventTop - el.parentElement.clientTop;
    ...
    getColourOnPositionOfPalette(el, ev) {
        if (el instanceof HTMLElement && ev instanceof MouseEvent) {
            ...
            var evLeft = ev.clientX - el.parentElement.clientLeft;
    ...
    setBackGround(ei) {
        ...
        palettePointerEl.addEventListener("mousemove", function (ev) {
            if (thisobj.draggingonpalette) {
                palettePointerEl.style.left = ev.clientX + "px";
                palettePointerEl.style.top = ev.clientY + "px";
